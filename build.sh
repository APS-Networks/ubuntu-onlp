...
BUILD_DIR_ONLPD=${ONL}/packages/base/any/onlp/builds/onlpd/BUILD
...
BIN_ONLPD=${BUILD_DIR_ONLPD}/${ONL_DEBIAN_SUITE}/${TOOLCHAIN}/bin/onlpd
...
sudo rm -f ${OUTPUT_DIR}/bin/onlpd
sudo rm -f ${OUTPUT_DIR}/bin/onlps
sudo rm -f ${LIB_OUTPUT_DIR}/libonlp-platform-defaults.so
sudo rm -f ${LIB_OUTPUT_DIR}/libonlp-${ONL_ARCH}-${ONIE_VENDOR}-${ONL_MACHINE}.so
sudo rm -f ${LIB_OUTPUT_DIR}/libonlp.so
sudo rm -f ${LIB_OUTPUT_DIR}/libonlp-platform.so
sudo rm -f ${LIB_OUTPUT_DIR}/libonlp.so.1
sudo rm -f ${LIB_OUTPUT_DIR}/libonlp-platform.so.1
sudo rm -f ${LIB_OUTPUT_DIR}/libonlp-platform-defaults.so.1
